...
Repositorio do primeiro desafio de projeto sobre Git/Github na DIO.

<h2 align="right">1.2. DESCRIÇÃO 📝</h2>

Nesse projeto se encontram o grupo de anotações realizados durante meu Bootcamp.
...
<h2 align="right" id="ponto1">1.4. COMO USAR 💡</h2>
<p align="right">Use os seguintes comandos (se tiver comandos) com <kbd>CTRL</kbd>+<kbd>V</kbd> quando necessário.</p>

📌 BAIXE OS ARQUIVOS E ABRA NA SUA MÁQUINA

<h2 align="right">1.5. OUTROS REPOSITORIOS 📘</h2>
